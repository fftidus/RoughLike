...
public class ArmorModel{
	...
	public function ArmorModel(nid:int) {
		NetID=nid;
	}
	...
	public function getTypeString():String{
		return SData_Default.getInstance().Dic["品质名"][rank]+SData_Default.getInstance().Dic["部位名"][position];
	}
	
	public function getURL():String{
		if(urlIcon!=null)	return urlIcon;
		return SData_Armor.getInstance().Dic[baseID]["图标"];
	}
	/** 获得基础属性文字介绍 */
	...
	public function toString():String{
		return "ArmorModel："+Name+"(nid="+NetID+",baseid="+baseID+")";
	}
	...
	public function getFightValue(role:RoleModel):void{
		...
		role.onChangeValues("防具buff"+position,buffs);
	}
